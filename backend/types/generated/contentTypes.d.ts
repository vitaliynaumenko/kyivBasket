...
export interface ApiLigaLiga extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::liga.liga', 'Sex'>;
    updatedAt: Attribute.DateTime;
...
export interface ApiNalashtuvannyaSajtuNalashtuvannyaSajtu
  extends Schema.SingleType {
  collectionName: 'nalashtuvannya_sajtus';
  info: {
    displayName: '\u041D\u0430\u043B\u0430\u0448\u0442\u0443\u0432\u0430\u043D\u043D\u044F \u0441\u0430\u0439\u0442\u0443';
    pluralName: 'nalashtuvannya-sajtus';
    singularName: 'nalashtuvannya-sajtu';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::nalashtuvannya-sajtu.nalashtuvannya-sajtu',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    liga: Attribute.Relation<'api::post.post', 'oneToOne', 'api::liga.liga'>;
    main_slider: Attribute.Boolean;
    publishedAt: Attribute.DateTime;
    title: Attribute.String;
    updatedAt: Attribute.DateTime;
